...
\exe{}{
	...
	\begin{enumerate}[itemsep=10pt]
		\item
		$x = \dfrac{3\times3}{7} = \dfrac97$.
		\item
		$\dfrac6x = 2$, donc $ x = \dfrac62 = 3$.
		\item
		$ x = \dfrac{16\times2}{\sqrt3} = \dfrac{32}{\sqrt3} = \dfrac{32}{3} \sqrt3$.
		\item
		$ x = \dfrac{-2}{4\sqrt3} = \dfrac{-1}6 \sqrt3$.
		\item
		$x = \dfrac{9\times5}{\sqrt6} = \dfrac{15}{2}\sqrt6$.
		\item
		$ x = \dfrac{-3\times7}{5\sqrt7} = \dfrac{-3}5 \sqrt7$.
		\item
		$x = \dfrac{-9\times3}{2\sqrt{11}} = \dfrac{-27}{22}\sqrt{11}$.
		\item
		$x = \dfrac{2}{-7\sqrt{14}} = \dfrac{-1}{49}\sqrt{14}$
	\end{enumerate}
	\end{multicols}
}
...
\exe{difficulty=1}{
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			\item
				\[ 365,2422 \approx 365 + \dfrac1a \iff 0,2422 \approx \frac1a \iff a \approx \frac1{0,2422} \approx 4,13. \]
		...
		\begin{enumerate}
			\item
				\[ 365,2422 \approx 365 + \dfrac14 - \dfrac{b}{400} \iff 0,0078 \approx \frac{b}{400} \iff b \approx 400\times0,0078 = 3,12. \]
