...
\dfn{nombres rationnels}{
	Soient $a, b \in \Z$ deux entiers relatifs, avec $b$ non nul.
...
%
%\exe{difficulty=0}{
%	Calculer la fraction suivante et réduire.
%	\[ 
...
%%	 d&= \frac{\frac{2}{5}+\frac{-3}{4}}{2+(-2)\times \frac{-7}{4}} &
%%	e&=\left(\frac{2}{3}+\frac{1}{2}\right) \times \frac{6}{25} &
%%	f&=\frac{-1+\frac{33}{11}}{\frac{2}{7}}
%%	% g&=\left(1+\frac{1}{2}\right) \div \frac{2}{3} &
%%	\end{align*}
%%}{exe:Samoyeau5}{
%%	sol1
%%}
