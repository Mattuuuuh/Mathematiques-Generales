...
\dfn{suite des restes et quotients}{
	...
	Une \emphindex{suite des restes} est la suite de polynôme $a_0, a_1, \dots, a_k \in\K[x]$ où, pour $i\geq0$,  
	\begin{enumerate}
		\item
	...
	Une \emphindex{suite des quotients} est la suite de polynôme $q_1, q_2, \dots, q_k \in\K[x]$ où, pour $i\geq0$,
