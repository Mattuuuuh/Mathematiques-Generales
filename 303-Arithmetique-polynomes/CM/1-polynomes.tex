...
\lem{de Gauss}{
	\begin{enumerate}
		...
		\item
		Soit $f$ un polynôme primitif et $g \in \Z[x]$.
		Si $f|g$ dans $\Q[x]$, alors $f|g$ dans $\Z[x]$.
	\end{enumerate}
...
\pf{}{
	\begin{enumerate}
		...
		Alors l'identité
			\[ c_g g_0 = c_q (fq_0) \]
		implique que $c_g = c_q$, par unicité du contenu et car $fq_0$ est primitif d'après le point 1.
	\end{enumerate}
}
