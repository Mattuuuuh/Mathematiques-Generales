...
\nt{
	Le concept d'\emphindex{anneau euclidien} se généralise sans peine en remplaçant le degré par une \emphindex{norme} (ou  \emphindex{stathme}) sur l'anneau $R$ qui prend ses valeurs dans $\N$.
}
...
\exe{}{
	...
	Cette condition garantie qu'un élément non nul se décompose en facteurs irréductibles, le seul danger de cette décomposition étant de ne jamais se terminer.
