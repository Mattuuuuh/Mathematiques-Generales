...
\exe{}{Est-ce que l'ensemble $\bigset{ -10 ; -9 ; \dots ; 9 ; 10}$ est un groupe lorsque muni de $+$ ?
}{exe:loi-non-interne}{
...
\dfn{anneau factoriel}{
	Un anneau intègre (donc commutatif, unitaire, et sans diviseur de zéro) $R$ est un \emphindex{anneau factoriel} si tout élément $r$ non nul et non inversible se décompose \underline{de façon unique} comme
		\[ r = p_1 \cdot p_2 \cdot \cdots \cdot p_k, \]
	avec les $p_i$ irréductibles, à multiplication par une unité et à permutation près.
}{dfn:anneau-factoriel}
