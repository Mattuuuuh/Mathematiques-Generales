...
\dfn{divisiblité}{
	...
	L'élément $a$ divise $b$ dans $R$ dès que
		\[ b = a\cdot q, \]
	où $q\in R$.
}{dfn:divisibilite}
...
\pf{}{
	...
	Chaque étape est essentielle et découle de l'étape précédente.
	Ce plan fera l'objet de la même considération dans l'anneau $\K[x]$ section \ref{sec:Kx} du chapitre \ref{chap:polynomes}.
	
	Dans l'anneau $\Z[x]$ étudié section \ref{sec:Zx} du chapitre \ref{chap:polynomes}, seules les deux dernières étapes sont accessibles et nécessitent donc une stratégie particulière.
	
	\begin{enumerate}[label=\bf\underline{Étape \arabic*.}, leftmargin=50pt]
		\item
	...
	Considérons $n\in\Z$ et démontrons le théorème \ref{thm:decomp-premiers} en admettant la véracité de chaque étape. 
