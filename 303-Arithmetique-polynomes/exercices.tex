...
\exe{}{
	...
	\begin{enumerate}
		...
		\item
		D'abord,
			\[ X^3 + 5X^2 + 2X - \frac1{\pi}X(\pi X^2 + 3) = 5X^2 + (2-\frac3{\pi})X, \]
		puis
			\[  5X^2 + (2-\frac3{\pi})X - \frac5{\pi} (\pi X^2 + 3) = (2-\frac3{\pi})X  - \frac{15}{\pi}. \]
		et donc finalement
			\[ X^3 + 5X^2 + 2X = (\frac1{\pi} X + \frac5{\pi}) (\pi X^2 + 3) + (2-\frac3{\pi})X  - \frac{15}{\pi}. \]
		\item 
