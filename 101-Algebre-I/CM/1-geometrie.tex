...
\thm{bilinéarité du produit scalaire}{
	...
	\begin{enumerate}
		...
		\item définie positive : $\japb{x, x} \geq 0$ avec égalité si et seulement si $x=0$ ; et
...
%
%\nt{
%	Nous verrons plus tard que toute base de $\R^2$ est de taille 2 : c'est sa \emphindex{dimension} en tant qu'espace vectoriel sur $\R$.
%	
