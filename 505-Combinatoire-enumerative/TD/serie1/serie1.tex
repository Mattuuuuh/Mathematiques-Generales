...
\exe{difficulty=1}{
	...
	\emph{Indication : montrer qu'un $m$-uplet de $[n]$ correspond à une unique fonction $f$ strictement croissante.}
...
\exe{}{
	 ...
	 \begin{enumerate}
	  	...
	  	\item 
	  	Quelle est la probabilité qu'aucun des clients de reçoivent sa lettre ?
%	  	\item 
...
\exe{}{
	...
	Montrer que parmis 7 entiers relatifs, la différence de deux d'entre eux est un multiple de 6.
}{exe:pidgin-whole0}{

}

\exe{}{
	Montrer que parmis 100 personnes, 9 d'entre elles sont nécessairement nées le même mois de l'année.
}{exe:pidgin-whole1}{
